...
# ASN.1 source file:///home/vla/ArrestedDevelopment/pygwarts/development/filch/mibs/SNMPv2-MIB.mib
...
Bits, Unsigned32, IpAddress, ObjectIdentity, snmpModules, ModuleIdentity, Gauge32, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, mib_2, iso, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "IpAddress", "ObjectIdentity", "snmpModules", "ModuleIdentity", "Gauge32", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "mib-2", "iso", "TimeTicks", "Counter32")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: snmpMIB.setRevisionsDescriptions(('This revision of this MIB module was published as RFC 3418.', 'This revision of this MIB module was published as RFC 1907.', 'The initial revision of this MIB module was published as RFC 1450.',))
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    snmpCommunityGroup1 = snmpCommunityGroup1.setStatus('current')
if mibBuilder.loadTexts: snmpCommunityGroup1.setDescription('A collection of objects providing basic instrumentation of a SNMP entity which supports community-based authentication.')
...
mibBuilder.exportSymbols("SNMPv2-MIB", sysORDescr=sysORDescr, snmpInBadCommunityUses=snmpInBadCommunityUses, snmpMIBCompliances=snmpMIBCompliances, snmpOutSetRequests=snmpOutSetRequests, sysORLastChange=sysORLastChange, snmpSilentDrops=snmpSilentDrops, snmpOutGenErrs=snmpOutGenErrs, snmpOutBadValues=snmpOutBadValues, snmpInReadOnlys=snmpInReadOnlys, snmpObsoleteGroup=snmpObsoleteGroup, snmpBasicComplianceRev2=snmpBasicComplianceRev2, snmpMIBObjects=snmpMIBObjects, snmpOutNoSuchNames=snmpOutNoSuchNames, snmpOutPkts=snmpOutPkts, snmpInNoSuchNames=snmpInNoSuchNames, snmpBasicNotificationsGroup=snmpBasicNotificationsGroup, snmpInGenErrs=snmpInGenErrs, snmpTrapOID=snmpTrapOID, snmpInASNParseErrs=snmpInASNParseErrs, sysObjectID=sysObjectID, snmpInGetNexts=snmpInGetNexts, snmpCommunityGroup1=snmpCommunityGroup1, snmpOutTraps=snmpOutTraps, sysUpTime=sysUpTime, sysORTable=sysORTable, snmpProxyDrops=snmpProxyDrops, snmpSetGroup=snmpSetGroup, snmp=snmp, snmpInSetRequests=snmpInSetRequests, snmpInGetResponses=snmpInGetResponses, snmpMIBConformance=snmpMIBConformance, snmpOutGetRequests=snmpOutGetRequests, sysORID=sysORID, snmpBasicCompliance=snmpBasicCompliance, snmpInBadValues=snmpInBadValues, snmpGroup=snmpGroup, snmpSetSerialNo=snmpSetSerialNo, sysServices=sysServices, snmpTrapEnterprise=snmpTrapEnterprise, warmStart=warmStart, sysDescr=sysDescr, systemGroup=systemGroup, snmpInTooBigs=snmpInTooBigs, sysLocation=sysLocation, coldStart=coldStart, PYSNMP_MODULE_ID=snmpMIB, snmpInBadCommunityNames=snmpInBadCommunityNames, sysORIndex=sysORIndex, snmpEnableAuthenTraps=snmpEnableAuthenTraps, snmpInTotalReqVars=snmpInTotalReqVars, snmpInTotalSetVars=snmpInTotalSetVars, snmpOutGetResponses=snmpOutGetResponses, system=system, sysORUpTime=sysORUpTime, snmpInBadVersions=snmpInBadVersions, snmpOutGetNexts=snmpOutGetNexts, sysName=sysName, sysOREntry=sysOREntry, sysContact=sysContact, snmpNotificationGroup=snmpNotificationGroup, authenticationFailure=authenticationFailure, snmpInPkts=snmpInPkts, snmpTrap=snmpTrap, snmpMIB=snmpMIB, snmpOutTooBigs=snmpOutTooBigs, snmpMIBGroups=snmpMIBGroups, snmpInTraps=snmpInTraps, snmpSet=snmpSet, snmpInGetRequests=snmpInGetRequests, snmpTraps=snmpTraps, snmpWarmStartNotificationGroup=snmpWarmStartNotificationGroup)
