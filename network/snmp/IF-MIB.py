...
# ASN.1 source file:///home/vla/ArrestedDevelopment/pygwarts/development/filch/mibs/IF-MIB.mib
...
TestAndIncr, TruthValue, PhysAddress, AutonomousType, DisplayString, RowStatus, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TruthValue", "PhysAddress", "AutonomousType", "DisplayString", "RowStatus", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", ifMIBObjects=ifMIBObjects, ifConformance=ifConformance, ifOperStatus=ifOperStatus, ifType=ifType, ifStackStatus=ifStackStatus, ifMtu=ifMtu, ifCompliances=ifCompliances, ifInUcastPkts=ifInUcastPkts, ifTestGroup=ifTestGroup, ifInErrors=ifInErrors, interfaces=interfaces, ifOutNUcastPkts=ifOutNUcastPkts, ifNumber=ifNumber, ifStackGroup=ifStackGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, OwnerString=OwnerString, ifHCPacketGroup=ifHCPacketGroup, ifStackTable=ifStackTable, ifOutDiscards=ifOutDiscards, ifHCInMulticastPkts=ifHCInMulticastPkts, ifCompliance2=ifCompliance2, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifStackEntry=ifStackEntry, ifAlias=ifAlias, ifHCOutOctets=ifHCOutOctets, ifRcvAddressGroup=ifRcvAddressGroup, ifPhysAddress=ifPhysAddress, ifTestTable=ifTestTable, ifRcvAddressStatus=ifRcvAddressStatus, ifOutErrors=ifOutErrors, ifTestEntry=ifTestEntry, ifXEntry=ifXEntry, ifRcvAddressEntry=ifRcvAddressEntry, ifTestStatus=ifTestStatus, InterfaceIndex=InterfaceIndex, ifPacketGroup=ifPacketGroup, ifTable=ifTable, ifRcvAddressType=ifRcvAddressType, ifEntry=ifEntry, ifSpeed=ifSpeed, ifFixedLengthGroup=ifFixedLengthGroup, ifCompliance=ifCompliance, ifOutOctets=ifOutOctets, ifInMulticastPkts=ifInMulticastPkts, ifXTable=ifXTable, ifInOctets=ifInOctets, linkUp=linkUp, ifMIB=ifMIB, ifTestCode=ifTestCode, ifTestType=ifTestType, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifDescr=ifDescr, ifSpecific=ifSpecific, ifOutMulticastPkts=ifOutMulticastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifAdminStatus=ifAdminStatus, ifGroups=ifGroups, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestOwner=ifTestOwner, ifStackGroup2=ifStackGroup2, ifHighSpeed=ifHighSpeed, ifInBroadcastPkts=ifInBroadcastPkts, ifCompliance3=ifCompliance3, ifInNUcastPkts=ifInNUcastPkts, linkDown=linkDown, ifInDiscards=ifInDiscards, ifRcvAddressTable=ifRcvAddressTable, ifStackLowerLayer=ifStackLowerLayer, ifConnectorPresent=ifConnectorPresent, ifIndex=ifIndex, ifGeneralGroup=ifGeneralGroup, ifHCInOctets=ifHCInOctets, ifOldObjectsGroup=ifOldObjectsGroup, ifTestResult=ifTestResult, PYSNMP_MODULE_ID=ifMIB, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifStackHigherLayer=ifStackHigherLayer, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutQLen=ifOutQLen, ifLastChange=ifLastChange, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTableLastChange=ifTableLastChange, ifOutUcastPkts=ifOutUcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifName=ifName, ifStackLastChange=ifStackLastChange, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestId=ifTestId, ifInUnknownProtos=ifInUnknownProtos, ifRcvAddressAddress=ifRcvAddressAddress)
